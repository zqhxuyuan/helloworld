 ...
 * 
 */
public class ConnectionStatusResponseParser extends
		AdminResponseBodyParser<ConnectionStatusResponse> {
	private static final ConnectionStatus[] EMPTY_CONN_STATUS = new ConnectionStatus[0];

	@Override
	protected void writeOther(ConnectionStatusResponse value, DataOutput out)
			throws IOException {
	...
	private void writeConns(ConnectionStatus[] conns, DataOutput out)
			throws IOException {
