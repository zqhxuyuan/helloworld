...
import rushmore.zbus.client.service.Scanner.Listener;
import rushmore.zbus.client.service.Scanner.ScanInfo;
...
public class ServiceLoader {
	...
	public void loadService(String servicePath){
		...
		scanner.scanJar(new Scanner.Listener() {
			@Override
			public void onScanned(Scanner.ScanInfo info) {
				try {
		...
		scanner.scanClass(new Scanner.Listener() {
			@Override
			public void onScanned(Scanner.ScanInfo info) {
				try {
