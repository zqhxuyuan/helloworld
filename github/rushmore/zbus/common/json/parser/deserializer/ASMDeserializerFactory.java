...
import static rushmore.zbus.common.json.util.ASMUtils.getDesc;
...
import rushmore.zbus.common.json.asm.ClassWriter;
import rushmore.zbus.common.json.asm.FieldVisitor;
import rushmore.zbus.common.json.asm.Label;
import rushmore.zbus.common.json.asm.MethodVisitor;
import rushmore.zbus.common.json.asm.Opcodes;
import rushmore.zbus.common.json.parser.DefaultJSONParser;
import rushmore.zbus.common.json.parser.Feature;
import rushmore.zbus.common.json.parser.JSONLexer;
import rushmore.zbus.common.json.parser.JSONLexerBase;
import rushmore.zbus.common.json.parser.JSONToken;
import rushmore.zbus.common.json.parser.ParseContext;
import rushmore.zbus.common.json.parser.ParserConfig;
import rushmore.zbus.common.json.parser.SymbolTable;
import rushmore.zbus.common.json.util.ASMClassLoader;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(rushmore.zbus.common.json.asm.Type.getType(ASMUtils.getDesc(fieldClass)));
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(rushmore.zbus.common.json.asm.Type.getType(ASMUtils.getDesc(itemClass)));
    ...
    void _deserialze(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(rushmore.zbus.common.json.asm.Type.getType(ASMUtils.getDesc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_list_item_deser__",
                          ASMUtils.getDesc(ObjectDeserializer.class));
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(rushmore.zbus.common.json.asm.Type.getType(ASMUtils.getDesc(itemType)));
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass) {
        ...
        if (fieldInfo.getFieldType() instanceof Class) {
            mw.visitLdcInsn(rushmore.zbus.common.json.asm.Type.getType(ASMUtils.getDesc(fieldInfo.getFieldClass())));
        } else {
            mw.visitVarInsn(ALOAD, 0);
            mw.visitLdcInsn(fieldInfo.getName());
